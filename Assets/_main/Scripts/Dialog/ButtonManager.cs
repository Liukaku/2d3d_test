...
namespace SpriteGame
{
    public class ButtonManager : MonoBehaviour
    {
        ...
        public Button ResponseButtonOne, ResponseButtonTwo, ResponseButtonThree, ResponseButtonFour, NextPageButton;
        public ButtonInfo buttonInfoOne, buttonInfoTwo, buttonInfoThree, buttonInfoFour;
